...
while True:
    ...
    # Print color variable values
    print(f"Red Color: {red_color}, Green Color: {green_color}, Blue Color: {blue_color}, Yellow Color: {yellow_color}")
